...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1c414284567d2a1b805cddb4a0cb4ffc) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Gen"; "GenClone"; "GenMList"; "Gen_intf"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bench_perms.ml"});
               SrcRepo
                 ({
                     cs_name = "head";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\194\233\200\179NE\127\199$\016\029\198\133\132\198\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
