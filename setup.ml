...
(* OASIS_START *)
(* DO NOT EDIT (digest: a6f8dcac0a01e6a0b846d923590e3b6e) *)
(*
...
let setup_t =
  {
     ...
     doc = [("gen", OCamlbuildDocPlugin.doc_build ".")];
     ...
     clean_doc = [("gen", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test =
       [
          ("all",
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "gen"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.0";
     oasis_digest =
       Some "\00121\142\199\229\165\252\241\028R\185\014\002\182o";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
